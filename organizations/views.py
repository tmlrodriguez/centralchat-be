...
class CompanyView(APIView):
    """
        ...
        - Company mutations are delegated to the organization operation layer.
    ...
    def post(self, request):
        ...
        company = create_company(validated_data=serializer.validated_data, actor=request.user)
    ...
    def patch(self, request, company_id):
        ...
        company = update_company(company=company, validated_data=serializer.validated_data, actor=request.user)
    ...
    def delete(self, request, company_id):
        ...
        try:
            company = deactivate_company(company=company, actor=request.user)

        except ValidationError as error:
            response_payload = {"error_message": "Desactivación de empresa rechazada: no fue posible completar la operación.", "data": error.message_dict}
...
class BranchView(APIView):
    """
        ...
        - Branch mutations are delegated to the organization operation layer.
    ...
    def post(self, request, company_id):
        ...
        branch = create_branch(company=company, validated_data=serializer.validated_data, actor=request.user)
    ...
    def patch(self, request, company_id, branch_id):
        ...
        branch = update_branch(branch=branch, validated_data=serializer.validated_data, actor=request.user)
    ...
    def delete(self, request, company_id, branch_id):
        ...
        try:
            branch = deactivate_branch(branch=branch, actor=request.user)

        except ValidationError as error:
            response_payload = {"error_message": "Desactivación de sucursal rechazada: no fue posible completar la operación.", "data": error.message_dict}
...
class UserCompanyAccessView(APIView):
    ...
    def post(self, request):
        ...
        try:
            access = grant_user_company_access(user=user, company=company, actor=request.user)

        except ValidationError as error:
            response_payload = {"error_message": "Asignación de acceso rechazada: no fue posible completar la operación.", "data": error.message_dict}
    ...
    def delete(self, request, access_id):
        ...
        try:
            ...
            response_payload = {"error_message": "Revocación de acceso rechazada: no fue posible completar la operación.", "data": error.message_dict}
...
class MyCompanyListView(APIView):
    """
        ...
        - This read-only operation does not generate an audit event.
    """
